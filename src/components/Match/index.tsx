...
function Match({home, away, result, identifier, date, live}: MatchProps) {
  ...
  const formattedDate = date ? new Date(date).toLocaleString("de", { year: "numeric", month: "2-digit", day: "2-digit", weekday: "short", hour: "2-digit", minute: "2-digit", timeZone: tz }) : null
  return (
