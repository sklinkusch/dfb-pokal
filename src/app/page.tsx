      ...
      <div className={styles.gridcontainer}>
        <div>
          ...
          <ul className={styles.ul}>
            <li>
              <Link href="/men/2026-27" className={styles.link}>Saison 2026/27</Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className={styles.ul}>
            <li>
              <Link href="/women/2026-27" className={styles.link}>Saison 2026/27</Link>
            </li>
            <li>
              <Link href="/women/2025-26" className={styles.link}>Saison 2025/26</Link>
            </li>
            <li>
